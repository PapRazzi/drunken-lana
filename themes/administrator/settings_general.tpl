                                            ...
                                            <div class="hor-scroll">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="scope-label">[FACEBOOK APPLICATION SECRET YOU GOT WHEN YOU CREATED YOUR VKONTAKTE APPLICATION]</td>
                                                        <td><small></small></td>
                                                    </tr>
                                                    
                                                    <tr class="hidden">
                                                        <td class="label"><label for="status">Vkontakte Application ID </label></td>
                                                        <td class="value">
                                                            <input id="VK_APPID" name="VK_APPID" value="{$VK_APPID}" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
                                                        <td class="scope-label">[VKONTAKTE APPLICATION ID YOU GOT WHEN YOU CREATED YOUR VKONTAKTE APPLICATION]</td>
                                                        <td><small></small></td>
                                                    </tr>
                                                    
                                                    <tr class="hidden">
                                                        <td class="label"><label for="status">Vkontakte Secret </label></td>
                                                        <td class="value">
                                                            <input id="VK_APP_PASSWORD" name="VK_APP_PASSWORD" value="{$VK_APP_PASSWORD}" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
                                                        <td class="scope-label">[VKONTAKTE APPLICATION SECRET YOU GOT WHEN YOU CREATED YOUR FACEBOOK APPLICATION]</td>
                                                        <td><small></small></td>
                                                    </tr>
                                                    
                                                    <tr class="hidden">
                                                        <td class="label"><label for="status">Robokassa Login</label></td>
                                                        <td class="value">
                                                            <input id="RK_LOGIN" name="RK_LOGIN" value="{$RK_LOGIN}" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
                                                        <td class="scope-label">[Robokassa Login]</td>
                                                        <td><small></small></td>
                                                    </tr> 
                                                   
                                                  <tr class="hidden">
                                                        <td class="label"><label for="status">Robokassa Pass 1</label></td>
                                                        <td class="value">
                                                            <input id="RK_PASS1" name="RK_PASS1" value="{$RK_PASS1}" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
                                                        <td class="scope-label">[Robokassa Pass 1 (request)]</td>
                                                        <td><small></small></td>
                                                    </tr> 
                                                   
                                                  <tr class="hidden">
                                                        <td class="label"><label for="status">Robokassa Pass 2</label></td>
                                                        <td class="value">
                                                            <input id="RK_PASS2" name="RK_PASS2" value="{$RK_PASS2}" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
                                                        <td class="scope-label">[Robokassa Pass 2 (response from robokassa)]</td>
                                                        <td><small></small></td>
                                                    </tr>     
