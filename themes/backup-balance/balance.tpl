                  ...
                  <div class="purse">
                    ...
                    <table width="100%">
                        <tr>
                            <td>
                                ...
                                <form id="pay" name="pay" method="POST" action="https://merchant.webmoney.ru/lmi/payment.asp">
                                    <input type="hidden" name="LMI_PAYEE_PURSE" value="R169507443777" />
                                    <label for="payment-amounth">Введите сумму</label>
                                    <input type="text" name="LMI_PAYMENT_AMOUNT" id="payment-amounth" />
                                    <input type="hidden" name="LMI_PAYMENT_DESC_BASE64" value="0J/QvtC/0L7Qu9C90LXQvdC40LUg0LHQsNC70LDQvdGB0LAg0L3QsCDRgdCw0LnRgtC1IGNoZWVyaWNrLnJ1" />
                        ...
                        <tr>
                            <td>
                                <h2>{$lang449}</h2>
                                <form action="/roxchange_send_payment_request.php" method="POST" />
                                    <label for="roboxchange-payment-amounth">Введите сумму</label>
                                    <input id="roboxchange-payment-amounth" type="text" name="OutSum" />
