                                ...
                                <div class="holder order-btn">
                                  <div class="gig-head">
                                    <div class="gig-title-l">
                                      <h1><a href="{$baseurl}/{$posts[i].seo|stripslashes}/{$posts[i].PID|stripslashes}/{$title}">{$lang62} {$posts[i].gtitle|stripslashes} {$lang63}{$posts[i].price|stripslashes}{$lang446}</a></h1>
                                  ...
                                  <div class="gig-content">
                                    ...
                                    <div class="gig-content-right">
                                      <div class="gig-image">
                                        <img alt="{$posts[i].gtitle|stripslashes}" src="/thumb/380x265xin/pics/{$posts[i].p1}" />
                                        <ul class="tags">
